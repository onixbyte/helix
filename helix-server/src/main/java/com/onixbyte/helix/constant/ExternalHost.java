 ...
 * <p>
 * This utility class provides centralised definitions for external service hosts,
 * API endpoints, and third-party integration points used throughout the Helix
 * application. It serves as a single source of truth for external service
 * configurations, promoting maintainability and consistency.
 * <p>
